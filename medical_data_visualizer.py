...
def draw_cat_plot():
    ...
    # 8. Get the figure for the output and save it
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask=mask, annot=True, fmt='.1f', ax=ax, cmap='coolwarm', vmin=-1, vmax=1, center=0, linewidths=.5, cbar_kws={'shrink': .5})
